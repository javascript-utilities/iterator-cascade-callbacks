...
import { GeneratorFunction, Static_Contract, Yielded_Data } from './lib/runtime-types.js';
 ...
 * @license AGPL-3.0
 */
@Static_Contract<Synchronous.Iterator_Cascade_Callbacks__Static<Iterator_Cascade_Callbacks>>()
class Iterator_Cascade_Callbacks implements Iterator_Cascade_Callbacks {
	 ...
	 * //> [ 4, 3 ]
	 */
	map(callback: Synchronous.Callback_Function, ...parameters: any[]): Iterator_Cascade_Callbacks {
		return this.pushCallbackWrapper({
...
class Wrappers {
	...
	static *zip(
		iterables: any[],
		iterator_cascade_callbacks: Synchronous.Iterator_Cascade_Callbacks__Static<Synchronous.Iterator_Cascade_Callbacks__Instance>
	 ...
	 */
	static entries(
		callback_object: Synchronous.Callback_Object__Instance,
		iterator_cascade_callbacks: Synchronous.Iterator_Cascade_Callbacks__Instance
	) {
 ...
 * @license AGPL-3.0
 */
// @Static_Contract<Synchronous.Callback_Object__Static<Callback_Object>>()
class Callback_Object implements Callback_Object {
	 ...
	 * @param {Synchronous.Iterator_Cascade_Callbacks__Instance} iterator_cascade_callbacks - Reference to `Iterator_Cascade_Callbacks` instance
	 * @this {Synchronous.Callback_Object__Instance}
	 */
	call(iterator_cascade_callbacks: Synchronous.Iterator_Cascade_Callbacks__Instance) {
 ...
 */
interface Iterator_Cascade_Callbacks extends Synchronous.Iterator_Cascade_Callbacks__Instance {
	constructor: typeof Iterator_Cascade_Callbacks;
}

interface Callback_Object extends Synchronous.Callback_Object__Instance {
