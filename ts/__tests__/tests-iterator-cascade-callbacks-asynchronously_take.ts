...
test('Iterator_Cascade_Callbacks_Asynchronously.take -> Can I has 2 elements?', async () => {
...
test('Iterator_Cascade_Callbacks_Asynchronously.take -> Can I has 4 elements at a time?', async () => {
	const page_size = 4;
...
test('Iterator_Cascade_Callbacks_Asynchronously.take -> Is anything broken by callbacks prior to taking?', async () => {
	const page_size = 4;
...
test('Iterator_Cascade_Callbacks_Asynchronously.take -> Is anything broken by callbacks after taking?', async () => {
	const page_size = 4;
...
// test('Iterator_Cascade_Callbacks_Asynchronously.take -> ', async () => {});
