...
test('Iterator_Cascade_Callbacks.collectToArray -> Are Arrays unmodified without callbacks?', async () => {
...
test('Iterator_Cascade_Callbacks.collectToArray -> Is collection from Generator function to Array supported?', async () => {
	const icca = new Iterator_Cascade_Callbacks(function* () {
...
test('Iterator_Cascade_Callbacks.collectToArray -> Is collection from Iterator function to Array supported?', async () => {
	const icca = new Iterator_Cascade_Callbacks(
		(function* () {
			for (let value of [6, 5, 4]) {
				yield value;
			}
...
test('Iterator_Cascade_Callbacks.collectToArray -> Can collecton be limited to 4 and resumed?', async () => {
