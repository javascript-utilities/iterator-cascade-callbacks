...
test('Iterator_Cascade_Callbacks.collectToObject -> Are Objects unmodified without callbacks?', async () => {
...
test('Iterator_Cascade_Callbacks.collectToObject -> Is it okay to limit collection amount?', async () => {
...
// test('Iterator_Cascade_Callbacks.collectToObject ->', async () => {});
