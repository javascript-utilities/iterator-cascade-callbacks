 ...
 */
@Static_Contract<Asynchronous.Iterator_Cascade_Callbacks__Static<Iterator_Cascade_Callbacks>>()
class Iterator_Cascade_Callbacks implements Iterator_Cascade_Callbacks {
	 ...
	 * })();
	 */
	map(callback: Asynchronous.Callback_Function, ...parameters: any[]): Iterator_Cascade_Callbacks {
		return this.pushCallbackWrapper({
	 ...
	 * })();
	 */
	async next(): Promise<Iterator_Cascade_Callbacks> {
	 ...
	 * @return {Asynchronous.Callback_Object__Instance?}
	 * @this {Iterator_Cascade_Callbacks}
	 */
 ...
 * @license AGPL-3.0
 */
// @Static_Contract<Asynchronous.Callback_Object__Static<Callback_Object>>()
class Callback_Object implements Callback_Object {
	 ...
	 * @param {Asynchronous.Iterator_Cascade_Callbacks__Instance} iterator_cascade_callbacks - Reference to `Iterator_Cascade_Callbacks` instance
	 * @this {Asynchronous.Callback_Object__Instance}
	 */
	async call(iterator_cascade_callbacks: Asynchronous.Iterator_Cascade_Callbacks__Instance) {
...
class Wrappers {
	...
	static async *zip(
		iterables: any[],
		iterator_cascade_callbacks: Asynchronous.Iterator_Cascade_Callbacks__Static<Asynchronous.Iterator_Cascade_Callbacks__Instance>
	...
	static entries(
		...
		iterator_cascade_callbacks: Asynchronous.Iterator_Cascade_Callbacks__Instance
	) {
...
if (typeof module !== 'undefined') {
	exports = module.exports = { Iterator_Cascade_Callbacks, Callback_Object, Wrappers };
}

export { Iterator_Cascade_Callbacks, Callback_Object, Wrappers };
...
interface Iterator_Cascade_Callbacks extends Asynchronous.Iterator_Cascade_Callbacks__Instance {
	constructor: typeof Iterator_Cascade_Callbacks;
}

interface Callback_Object extends Asynchronous.Callback_Object__Instance {
	constructor: typeof Callback_Object;
}
