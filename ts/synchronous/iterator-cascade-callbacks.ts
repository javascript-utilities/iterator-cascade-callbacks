...
export class Iterator_Cascade_Callbacks<Initial_Iterable_Value = unknown> {
	 ...
	 * @see {@link Synchronous.Callback_Wrapper}
	 * @see {@link Synchronous.Callback_Function}
	 */
	 ...
	 *
	 * @returns {unknown[]|Object|unknown}
	 *
	 * @throws {TypeError}
	 *
	 * @notes
	 ...
	 * @param {number?} amount - Limit collection to no more than amount
	 *
	 * @returns {unknown} target - The object that callback function has mutated
	 *
	 * @this {Iterator_Cascade_Callbacks}
	 *
	 * @see {@link Iterator_Cascade_Callbacks.collect For common entry point}
	 ...
	 *
	 * @param {Synchronous.Callback_Function} callback - Function that determines truth of `value` and/or `index_or_key` for each iteration
	 ...
	 *
	 * @example Collect even numbers from an array of numbers
	 *
	 * ```javascript
	 ...
	 *
	 * @param {Synchronous.Callback_Function} callback - Function that generally does not mutate `value` or `index_or_key` for `Iterator_Cascade_Callbacks` instance
	 * @param {...unknown[]} parameters - List of arguments that are passed to callback on each iteration
	 *
	 * @notes
	 ...
	 *
	 * @param {Synchronous.Callback_Function} callback - Function that logs something about each iteration
	 * @param {...unknown[]} parameters - List of arguments that are passed to callback on each iteration
	 *
	 * @this {Iterator_Cascade_Callbacks}
	 *
	 ...
	 *
	 * @param {Synchronous.Callback_Function} callback - Function may modify `value` and/or `index_or_key`
	 * @param {...unknown[]} parameters - List of arguments that are passed to callback on each iteration
	 *
	 * @returns {this}
	 *
	 ...
	 * @see {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Iterator}
	 */
	[Symbol.iterator]() {
		return this;
	}
