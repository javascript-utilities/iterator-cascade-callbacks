...
declare global {
  ...
  export namespace ICC {
     ...
     */
    export type Callback_Function = (value: any, index_or_key: Shared.Index_Or_Key, references: Callback_Function_References, ...parameters: any[]) => any;
     ...
     */
    export type Collect_To_Function = (target: any, value: any, index_or_key: Shared.Index_Or_Key, iterator_cascade_callbacks: Iterator_Cascade_Callbacks) => any;
  }
}
